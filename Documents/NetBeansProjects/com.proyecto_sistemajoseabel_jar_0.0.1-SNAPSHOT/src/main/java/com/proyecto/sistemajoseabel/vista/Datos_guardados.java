 ...
 * @author EQUIPO
 */
public class Datos_guardados extends javax.swing.JDialog {
     ...
     * @param parent
     */
    public Datos_guardados(Frame parent, boolean modal, String éxito, String datos_guardados_correctamente) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Datos guardados con exito!!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Datos_guardados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Datos_guardados dialog = new Datos_guardados(new javax.swing.JFrame(), true, "\u00c9xito", "Datos guardados correctamente");
