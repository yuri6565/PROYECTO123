 ...
 * @author EQUIPO
 */
public class Error_guardar extends javax.swing.JDialog {

    /**
     * Creates new form Error_guardar
     */
    public Error_guardar(Frame parent, boolean modal, String error, String par2) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Error_guardar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Error_guardar dialog = new Error_guardar(new javax.swing.JFrame(), true, "Error", "Error al guardar: ");
