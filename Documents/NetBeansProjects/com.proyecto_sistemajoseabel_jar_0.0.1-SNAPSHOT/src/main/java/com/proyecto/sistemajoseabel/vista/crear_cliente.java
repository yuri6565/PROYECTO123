...
public crear_cliente(Frame parent, boolean modal, ClienteService servicioCliente) {
    super(parent, modal);
    ...
    String numero = numerotxt.getText().trim();
    ...
    if (tipoIdentificacion.equals("Tipo de identificacion:") || numero.isEmpty() || nombre.isEmpty() || apellido.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Por favor complete todos los campos obligatorios.");
        return;
    }

    Cliente nuevoCliente = new Cliente();
    nuevoCliente.setIdentificacion(tipoIdentificacion);
  ...
  public static void startFrm(ApplicationContext context) {
       java.awt.EventQueue.invokeLater(() -> {
        crear_cliente ventana = context.getBean(crear_cliente.class);
