...
private ClienteService servicioCliente;
 ...
 public editar_cliente(java.awt.Frame parent, boolean modal, int idCliente) {
        super(parent, modal);
        initComponents();
        cargarDatosCliente(); 
    }
    ...
    Optional<Cliente> clienteOpt = servicioCliente.obtenerPorId(idcliente);

    // Verificar si el cliente existe
    if (clienteOpt.isPresent()) {
        Cliente cliente = clienteOpt.get();  // Obtener el cliente

        // Actualizar los datos del cliente con los valores de la UI
        cliente.setIdentificacion((String) identificaciontxt.getSelectedItem());
        cliente.setNumero(numerotxt.getText());
        ...
        JOptionPane.showMessageDialog(this, "Error al actualizar. Cliente no encontrado.");
    }
   ...
   Optional<Cliente> clienteOpt = servicioCliente.obtenerPorId(idcliente);
    ...
    if (clienteOpt.isPresent()) {
        ...
        numerotxt.setText(cliente.getNumero());
