 ...
 * @author EQUIPO
 */
public class espacio_alerta extends javax.swing.JDialog {
    

    /**
     * Creates new form espacio_alertga
     */
    public espacio_alerta(Frame parent, boolean modal, String error, String todos_los_campos_son_obligatorios) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(espacio_alerta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                espacio_alerta dialog = new espacio_alerta(new javax.swing.JFrame(), true, "Error", "Todos los campos son obligatorios");
