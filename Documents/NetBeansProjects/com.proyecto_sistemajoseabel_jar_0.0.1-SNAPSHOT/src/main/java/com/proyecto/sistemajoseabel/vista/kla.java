 ...
 * @author Personal
 */
public class kla extends javax.swing.JDialog {

    /**
     * Creates new form kla
     */
    public kla(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
setLocationRelativeTo(null); 
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 600, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                kla dialog = new kla(new javax.swing.JFrame(), true);
