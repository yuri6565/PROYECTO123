 ...
 * @author Personal
 */
public class cargando1 extends javax.swing.JDialog {

    /**
     * Creates new form kla
     */
    public cargando1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
setLocationRelativeTo(null); 
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Por favor, espera mientras procesamos tu solicitud");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                cargando1 dialog = new cargando1(new javax.swing.JFrame(), true);
